...
export const navigationItems = [
  ...
  { title: "Saúde WhatsApp", href: "/saude-evolution", icon: HeartPulse, permission: permissions.conversationsView },
  ...
  { title: "Cobertura", href: "/ceps", icon: MapPinned, permission: permissions.cepsView },
